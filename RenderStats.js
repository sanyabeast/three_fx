...
export default function (){
	...
	return {
		...
		update: function(webGLRenderer){
			...
			msTexts[i++].textContent = "Programs: "	+ (webGLRenderer.info.programs ? webGLRenderer.info.programs.length : 0);
			...
			msTexts[i++].textContent = "Frames: "	+ webGLRenderer.info.render.frame;
